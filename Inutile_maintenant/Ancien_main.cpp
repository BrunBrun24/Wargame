...
int main() {
    ...
    HEIGHT = 1080;
    WIDTH = 1920;
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "OpenGL", NULL, NULL);  // Width height title IDK IDK 
    if (!window) {
...
/*utilise des shaders donc c'est l'ancien code. sa peut servir pour voir ce qu'on fesais avant.*/